const SpanishPartners = require('../models/spanishPartners');
...
exports.getPartners = (req, res, next) => {
    ...
    const partners = SpanishPartners.find()
...
exports.createPartners = (req, res, next) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        let partners = new SpanishPartners(fields);
