const SpanishHr = require('../models/spanishHr');
const formidable = require('formidable');
const fs = require('fs');
const _ = require('lodash');

exports.hrById = (req, res, next, id) => {
    SpanishHr.findById(id)
...
exports.hrsByUser = (req, res) => {
    SpanishHr.find({ postedBy: req.profile._id })
