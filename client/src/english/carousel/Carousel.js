                    ...
                    <div className='text-center'>
                        {!carousel ? ( 
                                <div className='jumbotron text-center '>
                                    ...
                                    <div>
                                        <iframe width="100%" height="630" src="https://www.youtube.com/embed/Y3K1rtw5omA?loop=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
