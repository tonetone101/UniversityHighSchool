      ...
      <div>
        <Navbar id="topHeader" collapseOnSelect expand="lg" variant="dark">
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav
              className="mr-auto "
              className="col d-flex justify-content-around align-items-baseline"
            >
              ...
              <div id="link">
                <Nav.Link>
                  <Link style={{ color: "black" }} to="/boardmeeting">
                    School Board
                  </Link>
                </Nav.Link>
              </div>
              ...
              <div className="linked" id="link">
                <Nav.Link>
                  ...
                  >
                    <img
                      style={{ height: "100px" }}
                      src={require("../../images/uhsBannerLogo.png")}
                    />
                  </Link>
                </Nav.Link>
              </div>
